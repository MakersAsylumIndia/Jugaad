...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( has_post_thumbnail() && ('post' == get_post_type() || 'jugaad_tutorials' == get_post_type()) || 'jugaad_events' == get_post_type() && ( ! has_post_format() || has_post_format( 'image' ) || has_post_format( 'gallery' ) ) ) : ?>
	...
	<?php if ('post' == get_post_type() || 'jugaad_tutorials' == get_post_type()) : ?>
